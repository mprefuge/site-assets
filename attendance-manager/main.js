/**
 * Attendance Manager - Injectable Script for Squarespace
...
<div class="att-tracker hints-enabled">
  ...
  <div id="att-walkthrough-overlay" class="att-walkthrough-overlay">
    ...
    function init() {
        ...
        // Note: population of ministry/location selects is handled by
        // attendance-manager/scripts/am-script.js which populates from
        // window.lookup and then attempts to fetch authoritative values
        // from the API endpoint. We avoid duplicating that logic here.
